...
import SnippetsMobileMenu from "./SnippetsMobileMenu";
        ...
        <div className="relative h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <Link href="/" className="flex items-center gap-3 group relative">
              ...
              {/* Logo */}
              <div className="relative bg-gradient-to-br from-[#1a1a2e] to-[#0a0a0f] p-2 rounded-xl ring-1 ring-white/10 group-hover:ring-white/20 transition-all transform -rotate-180 group-hover:rotate-0 transition-transform duration-500">
